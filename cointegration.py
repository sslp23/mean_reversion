...
def test_cointegration(data: list, ticker1: str, ticker2: str):
    ...
    linreg = linregress(t1_vals, t2_vals)
    
    #residuals is the spread between the assets
    residuals = t1_vals - linreg.slope * t2_vals# - linreg.intercept
    #print(linreg.slope)
...
def simple_cointegration(tickers: list, st: str, end: str):
    ...
    plot_stocks(data, tickers[0], tickers[1])
    stocks_scatter(data, tickers[0], tickers[1])
